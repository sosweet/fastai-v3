...
export_file_url = 'https://www.dropbox.com/s/fkq0riebxqi6vi0/export152.pkl?dl=1'
...
async def analyze(request):
    ...
    if probabilty >= 0.6:
        prediction = str(prediction_val) + " with " + str(round(probabilty*100, ndigits =3)) + "% probabilty" 
    else:
